...
logo = """
\033[1;95m     |-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;92m     |               Pak Anonymous               |
\033[1;92m     |This Tool is Only for Pakistani FB Accounts|
\033[1;92m     |------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;96m           [⚡\033[1;97mAuthor Name: Alone Malang     ⚡\033[1;97m]
\033[1;96m           [⚡\033[1;97mPhone Numbr: +000 ⚡\033[1;96m]
\033[1;96m           [⚡\033[1;97mFb Account: Malang Jaan ⚡\033[1;96m]
\033[1;96m           [⚡       \033[1;97mFrom: Pakistan      ⚡\033[1;97m]
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://.github.com/channel/UCWLIAZHMlnlQMuMKTjBdbAQ')
    else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mJOIN WHATSAPP GROUP"
	print "\033[1;97m[4]\x1b[1;92mContact With Malang Jaan Owner On Facebook"
	print "\033[1;97m[5]\x1b[1;96mFacebook account name Malang Jaan " 
	print "\033[1;97m[0]\033[1;96mExit            "
	pilih()
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://gitub.com/UCWLIAZHMlnlQMuMKTjBdbAQ')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-----------------\033[1;91mAloneMalang\033[1;95m-----------------»"
		print logo
	...
	print "\033[1;95m«-----------------\033[1;91mMalang\033[1;95m-----------------»"
	...
	p.map(main, id)
#Dev:Babar_Ali
        print "\033[1;95m«-----------------\033[1;91mMalangjaan\033[1;95m-----------------»"
